    ...
    <section className="bg-brand-light py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          <p className="text-sm font-sans font-semibold tracking-widest text-brand-accent uppercase mb-3">
            Beyond Schools
          </p>
        ...
        >
          {cards.map((card) => (
            <motion.div
              ...
              className="bg-white border border-gray-200 rounded-xl overflow-hidden flex flex-col group"
            >
              {/* Image */}
