...
const JOBS = [
  {
    ...
    height: 1152,
    prompt:
      'Bright vibrant editorial photograph of a modern Children\'s Day camp festival in Abuja, Nigeria, mid-morning sun, crisp blue sky with light cumulus clouds. Foreground: a row of clean modern bell tents in forest green, mustard gold, and cream canvas, arranged in a graphic line on lush green grass dotted with wildflowers. Bright multicoloured bunting and gold pennant flags strung between tents in clear catenary curves. Children aged 6 to 10 in matching cream and forest-green house T-shirts running and laughing between tents — shown from behind or in motion blur, faces never identifiable. A few colourful camp chairs and a wooden picnic table with mocktail jars in the mid-ground. Acacia trees in the background under bright daylight. Saturated colours, punchy contrast, modern lifestyle photography aesthetic — think contemporary outdoor brand campaign, not documentary. Sharp focus throughout, slight wide-angle perspective, no lens flare. No text, no logos, no readable signage.',
  },
  {
    name: 'positioning',
    width: 1280,
  ...
  },
  {
    ...
    height: 1152,
    prompt:
      'Wide vibrant lifestyle photograph of a modern outdoor camp festival in Abuja, Nigeria, bright midday sun, crisp blue sky. Foreground: a long communal wooden table dressed with cream linen runner, glass jars of brightly coloured mocktails (pink hibiscus, orange citrus, green mint), terrazzo platters of West African small chops, fresh tropical fruit in a wooden bowl. Mid-ground: three modern bell tents in mustard gold, forest green, and cream pitched on bright green grass, with Adire-pattern flags fluttering on tall slim poles. Bunting in cream, gold, and coral strung in clean catenary curves between the tents. A geometric Adire-printed welcome arch in forest green and white frames the right side of the composition (no text on it). Two small figures in the deep background — one carrying a bucket, one walking — both motion-blurred, no faces visible. Acacia trees and a clear horizon behind. Saturated colours, sharp focus, modern outdoor brand campaign aesthetic — confident, joyful, contemporary. No text, no logos, no readable signage.',
  },
  {
