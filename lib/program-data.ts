  ...
  tiers: [
    {
      ...
      includes: [
        ...
        'Closing awards',
        'Best for: primary schools or first-time camps',
      ],
    },
    {
      name: 'Trail',
      ...
      includes: [
        ...
        'Best for: secondary schools without overnight commitment',
      ],
    },
    {
      name: 'Summit',
      ...
      includes: [
        ...
        'Evening gathering and bonfire',
        'Tent setup, sports, creative, and reflection',
        'Award ceremony and certificates',
        'Best for: boarding schools or senior cohorts',
      ],
    },
  ],
}
